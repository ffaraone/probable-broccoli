# Welcome to Connect Extension project test_async

## Next steps

You may open your favourite IDE and start working with your project, please note that this project runs using docker.
You may modify at any time the credentials used to authenticate to connect modifying the file *test_async/.test_async_dev.env*.
...
```sh
$ docker compose up test_async_dev
```
...
```sh
$ docker compose up test_async_bash
```
...
```sh
$ docker compose up test_async_test
```
